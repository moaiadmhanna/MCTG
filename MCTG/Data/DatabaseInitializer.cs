...
public class DatabaseInitializer
{
    ...
    private void InitializeCards()
    {
        ...
        ('Goblin', 'monster', 'Water', 40, 1, 'Goblin'),
        ...
        ('Fire Goblin', 'monster', 'Fire', 45, 1, 'Goblin'),
        ...
        ('Mystic Goblin', 'monster', 'Normal', 45, 1, 'Goblin'),
        ('Frost Wizard', 'monster', 'Water', 55, 1, 'Wizzard'),
        ('Dragon Rider', 'monster', 'Fire', 90, 1, 'Dragon'),
        ('Holy Knight', 'monster', 'Normal', 80, 1, 'Knight'),
        ...
        ('Arcane Wizard', 'monster', 'Fire', 70, 1, 'Wizzard'),
        ...
        ('Goblin Assassin', 'monster', 'Normal', 55, 1, 'Goblin'),
