...
public class DatabaseInitializer
{
    ...
    private void InitializeCards()
    {
        ...
        ('Wizard', 'monster', 'Fire', 30, 6, 'Wizzard'),
        ('Dragon', 'monster', 'Fire', 80, 2, 'Dragon'),
        ('Knight', 'monster', 'Normal', 60, 10, 'Knight'),
        ('Kraken', 'monster', 'Water', 70, 6, 'Krake'),
        ('Fire Elf', 'monster', 'Fire', 55, 3, 'FireElve'),
        ('Orc', 'monster', 'Normal', 50, 6, 'Ork'),
        ('Fire Goblin', 'monster', 'Fire', 45, 5, 'Goblin'),
        ('Water Wizard', 'monster', 'Water', 35, 4, 'Wizzard'),
        ('Ice Dragon 1', 'monster', 'Water', 75, 6, 'Dragon'),
        ('Knight of the Flame', 'monster', 'Fire', 65, 6, 'Knight'),
        ('Shadow Kraken', 'monster', 'Normal', 90, 6, 'Krake'),
        ('Forest Fire Elf', 'monster', 'Fire', 60, 12, 'FireElve'),
        ('Savage Orc', 'monster', 'Normal', 55, 4, 'Ork'),
        ('Stone Goblin', 'monster', 'Normal', 40, 4, 'Goblin'),
        ('Lightning Wizard', 'monster', 'Fire', 50, 2, 'Wizzard'),
        ('Ancient Dragon', 'monster', 'Fire', 100, 4, 'Dragon'),
        ('Armored Knight', 'monster', 'Normal', 70, 5, 'Knight'),
        ('Deep Sea Kraken', 'monster', 'Water', 85, 7, 'Krake'),
